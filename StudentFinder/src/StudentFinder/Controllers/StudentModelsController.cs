...
namespace StudentFinder.Controllers
{
    public class StudentModelsController : Controller
    {
        ...
        public StudentModelsController(StudentFinderContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,GradeLevel,StudentId,fName,lName")] StudentModel studentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,GradeLevel,StudentId,fName,lName")] StudentModel studentModel)
        {
